                ...
                <form action="{{ route('warkah.update', $warkah->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-file">
                          ...
                          <label class="custom-file-label" for="customFile">{{$warkah->nama_file ? $warkah->nama_file:'Choose file' }} </label>
                        </div>
                        <input type="hidden" name="param_file" value="{{$warkah->nama_file ? '1':'0' }}">
